...
fabric_silver_path = f"abfss://{workspace}@onelake.dfs.fabric.microsoft.com/a8dbca7d-3067-46ee-b7f4-d09971336f2e/Tables/silver_data"
...
# MAGIC %%sql
# MAGIC 
# MAGIC SELECT * FROM Silver_Lakehouse.silver_data LIMIT 1000
