...
df = spark.read.format('delta').load(f"abfss://{workspace}@onelake.dfs.fabric.microsoft.com/a8dbca7d-3067-46ee-b7f4-d09971336f2e/Tables/silver_data").filter(col("Processing_Date") == str(today_date))
...
dim_student_table_path = f"abfss://{workspace}@onelake.dfs.fabric.microsoft.com/ea6f25ae-276d-4619-bd35-44e73f0e9780/Tables/dim_student"
...
# MAGIC %%sql
# MAGIC 
# MAGIC SELECT * FROM Gold_Lakehouse.dim_student LIMIT 1000
...
dim_course_table_path = f"abfss://{workspace}@onelake.dfs.fabric.microsoft.com/ea6f25ae-276d-4619-bd35-44e73f0e9780/Tables/dim_course"
...
fact_student_table_path = f"abfss://{workspace}@onelake.dfs.fabric.microsoft.com/ea6f25ae-276d-4619-bd35-44e73f0e9780/Tables/fact_student_performance"
...
# MAGIC %%sql
# MAGIC 
# MAGIC SELECT * FROM Gold_Lakehouse.fact_student_performance LIMIT 1000
